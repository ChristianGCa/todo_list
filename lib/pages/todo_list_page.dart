          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Expanded(
                    // Espande até a máxima largura disponível da tela
                    child: TextField(
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                        backgroundColor: Color(0xff00fbfb),
  ...
  void onDelete(Todo todo) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      ...
      action: SnackBarAction(
        ...
        onPressed: () {
          setState(() {
            // Aqui temos certeza de que não são nulos, pois setamos eles anteriormente
